...
namespace DersDemo_Win_Printing.DataLayer {
...
namespace DersDemo_Win_Printing.DataLayer.NWDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Products] WHERE (([ProductID] = @Original_ProductID) AND ([ProductName] = @Original_ProductName) AND ((@IsNull_UnitPrice = 1 AND [UnitPrice] IS NULL) OR ([UnitPrice] = @Original_UnitPrice)) AND ((@IsNull_UnitsInStock = 1 AND [UnitsInStock] IS NULL) OR ([UnitsInStock] = @Original_UnitsInStock)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Products] ([ProductName], [UnitPrice], [UnitsInStock]) VALUES (@ProductName, @UnitPrice, @UnitsInStock);
SELECT ProductID, ProductName, UnitPrice, UnitsInStock, UnitPrice * UnitsInStock AS TotalPrice FROM Products WHERE (ProductID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Products] SET [ProductName] = @ProductName, [UnitPrice] = @UnitPrice, [UnitsInStock] = @UnitsInStock WHERE (([ProductID] = @Original_ProductID) AND ([ProductName] = @Original_ProductName) AND ((@IsNull_UnitPrice = 1 AND [UnitPrice] IS NULL) OR ([UnitPrice] = @Original_UnitPrice)) AND ((@IsNull_UnitsInStock = 1 AND [UnitsInStock] IS NULL) OR ([UnitsInStock] = @Original_UnitsInStock)));
SELECT ProductID, ProductName, UnitPrice, UnitsInStock, UnitPrice * UnitsInStock AS TotalPrice FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DersDemo_Win_Printing.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT     ProductID, ProductName, UnitPrice, UnitsInStock, UnitPrice * UnitsInSt" +
                "ock AS TotalPrice\r\nFROM         Products";
        ...
        public virtual int Delete(int Original_ProductID, string Original_ProductName, global::System.Nullable<decimal> Original_UnitPrice, global::System.Nullable<short> Original_UnitsInStock) {
            ...
            if ((Original_UnitsInStock.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((short)(Original_UnitsInStock.Value));
            }
            else {
        ...
        public virtual int Update(string ProductName, global::System.Nullable<decimal> UnitPrice, global::System.Nullable<short> UnitsInStock, int Original_ProductID, string Original_ProductName, global::System.Nullable<decimal> Original_UnitPrice, global::System.Nullable<short> Original_UnitsInStock, int ProductID) {
            if ((ProductName == null)) {
                throw new global::System.ArgumentNullException("ProductName");
            }
            else {
            ...
            if ((Original_UnitsInStock.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((short)(Original_UnitsInStock.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, global::System.Nullable<decimal> UnitPrice, global::System.Nullable<short> UnitsInStock, int Original_ProductID, string Original_ProductName, global::System.Nullable<decimal> Original_UnitPrice, global::System.Nullable<short> Original_UnitsInStock) {
            return this.Update(ProductName, UnitPrice, UnitsInStock, Original_ProductID, Original_ProductName, Original_UnitPrice, Original_UnitsInStock, Original_ProductID);
        }
    }
    ...
    [global::System.ComponentModel.DesignerAttribute("Microsoft.VSDesigner.DataSource.Design.TableAdapterDesigner, Microsoft.VSDesigner" +
        ", Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
    public partial class EmployeeOrderReportTableAdapter : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        public EmployeeOrderReportTableAdapter() {
            this.ClearBeforeFill = true;
        }
        ...
        private void InitAdapter() {
            ...
            global::System.Data.Common.DataTableMapping tableMapping = new global::System.Data.Common.DataTableMapping();
            tableMapping.SourceTable = "Table";
            tableMapping.DataSetTable = "EmployeeOrderReport";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT     e.EmployeeID AS 'Employee ID', e.FirstName + ' ' + e.LastName AS 'Employee Name', YEAR(o.OrderDate) AS 'Year', MONTH(o.OrderDate) AS 'Month', 
...
ORDER BY 'Employee Name', 'Year', 'Month'";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(NWDataSet.EmployeeOrderReportDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual NWDataSet.EmployeeOrderReportDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            NWDataSet.EmployeeOrderReportDataTable dataTable = new NWDataSet.EmployeeOrderReportDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
    }
